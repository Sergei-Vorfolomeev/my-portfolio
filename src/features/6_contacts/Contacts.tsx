      ...
      <div className={s.flipCard}>
        ...
        <div className={s.back}>
          ...
          <div className={s.gitHub}>
            ...
            <a href="https://github.com/Sergei-Vorfolomeev">github.com/Sergei-Vorfolomeev</a>
          </div>
          <div className={s.linkedIn}>
            ...
            <a href="https://www.linkedin.com/in/sergey-vorfolomeev/">
          ...
          <div className={s.telegram}>
            ...
            <a href="https://t.me/divine_mushroom">@divine_mushroom</a>
          </div>
        </div>
      </div>
    </div>

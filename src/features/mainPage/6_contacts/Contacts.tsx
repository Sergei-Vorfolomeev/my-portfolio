      ...
      <div className={s.flipCard}>
        ...
        <div className={s.back}>
          <ul className={s.socialLinks}>
            <li>
              <a href="tel:+420777194714" className={s.circlePhone}>
            ...
            <li>
              <a href="mailto:vorfo1897@gmail.com" className={s.circleMail}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="28"
                  height="28"
            ...
            <li>
              <a href="https://github.com/Sergei-Vorfolomeev" className={s.circleGitHub}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="28"
                  height="28"
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/sergey-vorfolomeev/"
                className={s.circleLinkedIn}
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="28"
            ...
            <li>
              <a href="https://t.me/divine_mushroom" className={s.circleTelegram}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="28"
                  height="28"
